...
{
    std:: string outFileNameSTDs  = "/stds.txt";
    std:: string outFileNameMeans = "/means.txt";
    std:: string outFileNewSeg   = "/seg_New.nii";
    std:: string fileName;
...
//       char*  fileNameSegNew;
    ...
    try
    {
        ...
        seg_EM_old SEG(segment_param->numb_classes,InputImage->dim[5],InputImage->dim[4]);
        ...
        //saurabh
        /*fileName  = segment_param->filename_out;
        //caution: no error checking here
        std::string directory = fileName.substr(0,fileName.find_last_of('/'));
         cout <<  "Directory:" << directory<<endl;
         fileNameSegNew = (char*)((directory + outFileNewSeg).c_str());
         cout<< "SegNew file name: " << fileNameSegNew<<endl;
        nifti_image * Result1 = SEG.GetResultNew(fileNameSegNew);
        nifti_image_write(Result1);*/
        //
        nifti_image_free(Result);
        // nifti_image_free(Result1);//saurabh
        ...
        //save the mean and stds of the classes in file
        // get the direcectory to save files
        fileName  = segment_param->filename_out;
        //caution: no error checking here
        directory = fileName.substr(0,fileName.find_last_of('/'));

        ofstream mean_file;
        fileName1 = (directory + outFileNameMeans).c_str();
        mean_file.open(fileName1);
        ...
        ofstream std_file;
        fileName2 = (directory + outFileNameSTDs).c_str();
        std_file.open(fileName2);
