...
NIFTYSEG_WINEXPORT void GaussianFilter4D_cArray_old(segPrecisionTYPE * ShortData, int * S2L, int * L2S, segPrecisionTYPE gauss_std, ImageSize * CurrSizes, int class_with_CSF);
